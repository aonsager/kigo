...
default --manifest input; only ever writes to --out.
...
def main(argv=None) -> int:
    ...
    # Only reached once the manifest is fully built in memory, so a parse or
    # assembly failure above never leaves a partial/broken file at --out.
